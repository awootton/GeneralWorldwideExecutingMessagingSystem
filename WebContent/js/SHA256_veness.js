 ...
 * 
 * atw changed this to byte arrays
 * 
 * @namespace
 */
var Sha256 = {};
...
Sha256.hash = function(msg) {
	...
	return Sha256.toBinaryStr(H[0]) + Sha256.toBinaryStr(H[1]) + Sha256.toBinaryStr(H[2]) + Sha256.toBinaryStr(H[3])
			+ Sha256.toBinaryStr(H[4]) + Sha256.toBinaryStr(H[5]) + Sha256.toBinaryStr(H[6]) + Sha256.toBinaryStr(H[7]);
};
...
// atw returns byte array in a string
Sha256.toBinaryStr = function(n) {
 ...
 * 
 * Copyright (C) 1999 Masanao Izumo <iz@onicos.co.jp> Version: 1.0 LastModified: Dec 25 1999 This library is free. You
 * can redistribute it and/or modify it.
 */

function XXXXUtf8ArrayToStr(array) {
	var out, i, len, c;
	var char2, char3;
